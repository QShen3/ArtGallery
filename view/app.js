window.addEventListener('DOMContentLoaded', function(e) {
    ...
    function newNode() {
        ...
        return function() {
            ...
            title.appendChild(document.createTextNode('opus-name'));
            content.appendChild(title);
            var title = document.createElement('h6');
            title.appendChild(document.createTextNode('opus-owner'));
            content.appendChild(title);
            var p = document.createElement('p');
            p.appendChild(document.createTextNode('opus-intro'));
